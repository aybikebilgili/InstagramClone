    ...
    <View style={styles.container}>
      <View style={styles.headerWrapper}>
        <View style={styles.headerLeftWrapper}>
          <Image
            ...
            source={require('../images/face.jpeg')}
          />
          <Text style={styles.headerTitle}> Catherine</Text>
        </View>
        <Image style={styles.icon} source={require('../images/dots.jpg')} />
      </View>
      <View>
        <Image
          style={styles.feedImage}
          source={require('../images/feedImage.jpg')}
        />
      </View>
      <View style={styles.feedImageFooter}>
        <View style={styles.feddimageFooterLeftWrapper}>
          <Image
            style={styles.icon}
            source={require('../images/heartfeed.jpg')}
          />
          <Image
            style={styles.icon}
          ...
          <Image
            style={styles.icon}
            source={require('../images/messagefeed.png')}
          />
        </View>
        <Image
          style={styles.icon}
          source={require('../images/bookmarkfeed.png')}
        />
      </View>
